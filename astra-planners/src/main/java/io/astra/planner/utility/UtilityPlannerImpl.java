package io.astra.planner.utility;
...
public class UtilityPlannerImpl implements GoapPlanner {
    private static final Logger log = LoggerFactory.getLogger(UtilityPlannerImpl.class);
    private final AstraConfig config;

    public UtilityPlannerImpl(AstraConfig config) {
        this.config = config;
    }
