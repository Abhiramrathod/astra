...
public double repairUtility(WorldState state) {
    ...
    return damageLevel * 2.0;
      ...
      <p>
        ...
        and stores it in the <code>ActionInfo</code>. When utility-based planners
        call <code>action.computeUtility(state)</code>, the method is invoked with the
      ...
      <h2 id="decompositions">Decomposition Patterns</h2>
      <p>
        Structural decomposition breaks compound tasks into smaller subtasks recursively.
        This guide covers advanced decomposition usage patterns.
      </p>
...
public void prepareIngredients() {}`}</code></pre>
      ...
      <p>
        Add a custom planner without modifying Astra's source code by implementing
        <code>Planner</code> and <code>PlannerProvider</code>, then registering via
        <code>ServiceLoader</code>.
      </p>
      <p>See the <a href="#/spi">SPI &amp; Custom Planners</a> page for the full guide, including code examples, custom <code>PlannerType</code> strategies, and a working random-planner example.</p>
      ...
      <p>
        ...
        Add the dependency, annotate with <code>@EnableAstra</code>, and inject the <code>Astra</code> bean.
      </p>
      <p>See the <a href="#/spring">Spring Integration</a> page for the full guide, covering auto-configuration, application properties, agent bean registration, event bridging, and async execution.</p>
...
restored.get("hasBeans"); // Optional["true"]`}</code></pre>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>astra.planner.maxIterations</code></td><td><code>Integer</code></td><td><code>10000</code> (cost-based)<br /><code>20</code> (utility-based)<br /><code>100</code> (hybrid)<br /><code>200</code> (structural)</td><td>All</td><td>Maximum search/planning iterations</td></tr>
          <tr><td><code>astra.planner.heuristic</code></td><td><code>String</code></td><td><code>unmatched</code></td><td>Cost-based</td><td>Heuristic mode: <code>unmatched</code> or <code>zero</code></td></tr>
        </tbody>
      </table>
