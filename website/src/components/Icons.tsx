...
export function LeafIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 0 1 9.8 6.906C7.05 9.346 5.5 12.5 5.5 17c0 .663.07 1.313.203 1.94A7.004 7.004 0 0 0 11 20Z"/><path d="M19.5 11.5c0-4.5-4-8-8.5-8-4 0-7.5 3.5-7.5 8 0 2.5 1.5 5 3.5 6.5 2 1.5 4.5 2 7 1.5 2.5-.5 4.5-2 5.5-4.5 1-2.5 0-5.5-1.5-7.5 1.5 1 2.5 2.5 2.5 4.5 0 1-.5 2-1.5 3"/>
    </svg>
  )
}
