...
export default function Sidebar({ mobileOpen }: { mobileOpen?: boolean }) {
  return (
    <aside className={`sidebar ${mobileOpen ? 'open' : ''}`}>
      ...
      <nav>
        <div className="sidebar-section">Getting Started</div>
        <NavLink to="/" end><HomeIcon /> Home</NavLink>
        <NavLink to="/getting-started"><RocketIcon /> Getting Started</NavLink>

        <div className="sidebar-section">Docs</div>
        <NavLink to="/architecture"><BlocksIcon /> Architecture</NavLink>
        <NavLink to="/planners"><GitBranchIcon /> Planners</NavLink>
        <NavLink to="/api"><BookOpenIcon /> API Reference</NavLink>

        <div className="sidebar-section">Guides</div>
        <NavLink to="/guides"><CpuIcon /> Guides</NavLink>
        <NavLink to="/samples"><FileCodeIcon /> Samples</NavLink>

        <div className="sidebar-section">Support</div>
        <NavLink to="/faq"><HelpCircleIcon /> FAQ</NavLink>

        <div className="sidebar-section">Links</div>
        <a href="https://github.com/Abhiramrathod/astra" target="_blank" rel="noopener"><GithubIcon /> GitHub</a>
      </nav>
    </aside>
  )
}
