...
/** Sample agent demonstrating compound task decomposition for cooking a meal. */
@Agent
public class CookingAgent {
    ...
    @Action(name = "ChopVegetables", description = "Chop fresh vegetables for the pasta dish",
        preconditions = @Fact(name = "hasKnife", value = "true"),
        effects = @Fact(name = "veggiesChopped", value = "true"))
    public void ChopVegetables() { log.info("Chopping vegetables..."); }

    @Action(name = "BoilWater", description = "Bring a pot of water to a rolling boil",
    ...
    @Action(name = "CookPasta", description = "Cook pasta in boiling water with vegetables",
        preconditions = {@Fact(name = "veggiesChopped", value = "true"), @Fact(name = "waterBoiled", value = "true")},
        effects = @Fact(name = "pastaCooked", value = "true"))
    public void CookPasta() { log.info("Cooking pasta..."); }

    @Action(name = "ServeMeal", description = "Plate and serve the finished meal",
        preconditions = @Fact(name = "pastaCooked", value = "true"),
        effects = @Fact(name = "mealServed", value = "true"))
    public void ServeMeal() { log.info("Serving the meal!"); }

    @Action(name = "MicrowaveMeal", description = "Heat a pre-made frozen meal in the microwave",
        preconditions = @Fact(name = "hasMicrowaveMeal", value = "true"),
        effects = @Fact(name = "mealServed", value = "true"))
    public void MicrowaveMeal() { log.info("Beeping microwave... meal ready!"); }
}
